            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 md:grid-cols-2 mx-4 gap-2'>
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure className='h-96'>
                        <LazyLoadImage
                            ...
                            width={400}
                        />
                        {/* <img className='' src="https://images.pexels.com/photos/5966431/pexels-photo-5966431.jpeg" alt="Shoes" /> */}
                    </figure>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    ...
                    <LazyLoadImage
                            effect='blur'
                            height={300}
                            src="https://images.pexels.com/photos/7262911/pexels-photo-7262911.jpeg"
                            width={400}
                        />
                        {/* <img src="https://images.pexels.com/photos/7262911/pexels-photo-7262911.jpeg" alt="Shoes" /> */}
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    ...
                    <LazyLoadImage
                            effect='blur'
                            height={300}
                            src="https://images.pexels.com/photos/7525172/pexels-photo-7525172.jpeg"
                            width={400}
                        />
                        {/* <img src="https://images.pexels.com/photos/7525172/pexels-photo-7525172.jpeg" alt="Shoes" /> */}
