    ...
    return (
        <div>
            <div>
                ...
                <form className='shadow-xl w-[90%] mx-auto my-8'>
                    ...
                    <input type="text" name="message" className='shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight py-8 focus:outline-none focus:shadow-outline' placeholder='Type Your Message...' />
                    <br />
